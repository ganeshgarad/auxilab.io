    ...
    >
      <div className="flex items-center gap-4">
        <div className="cursor-grab">
          <div className="i-ph:dots-six-vertical w-4 h-4 text-auxilab-elements-textSecondary" />
        </div>
        <div>
          <div className="font-medium text-auxilab-elements-textPrimary">{TAB_LABELS[tab.id]}</div>
          {showControls && (
            <div className="text-xs text-auxilab-elements-textSecondary">
      ...
      {showControls && !tab.locked && (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm text-auxilab-elements-textSecondary">Visible</label>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm text-auxilab-elements-textSecondary">User</label>
            <Switch
            ...
            />
            <label className="text-sm text-auxilab-elements-textSecondary">Dev</label>
          </div>
        </div>
      )}
    </motion.div>
