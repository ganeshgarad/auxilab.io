      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-auxilab-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-auxilab-elements-item-backgroundAccent hover:bg-auxilab-elements-artifacts-backgroundHover"
