      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-auxilab-elements-textPrimary dark:text-auxilab-elements-textPrimary-dark'
              : 'text-auxilab-elements-textSecondary dark:text-auxilab-elements-textSecondary-dark hover:text-auxilab-elements-textPrimary dark:hover:text-auxilab-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-auxilab-elements-textTertiary dark:text-auxilab-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
