        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-auxilab-elements-background-depth-2 dark:bg-auxilab-elements-background-depth-3 text-auxilab-elements-textPrimary dark:text-auxilab-elements-textPrimary-dark hover:bg-auxilab-elements-background-depth-3 dark:hover:bg-auxilab-elements-background-depth-4 border border-auxilab-elements-borderColor dark:border-auxilab-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
