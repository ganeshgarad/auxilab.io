  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-auxilab-elements-borderColor bg-auxilab-elements-background-depth-1 text-auxilab-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-auxilab-elements-textSecondary', className)} {...props} />;
  },
);
