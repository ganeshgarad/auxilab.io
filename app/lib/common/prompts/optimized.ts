...
<artifact_info>
  ...
  - Use \`<auxilabArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<auxilabAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<auxilabArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<auxilabAction>\` tags with appropriate \`type\` attribute:
