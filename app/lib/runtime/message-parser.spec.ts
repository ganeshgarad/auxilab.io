...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out auxilab artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <auxilab', 'Foo bar '],
      ['Foo bar <auxilaba', 'Foo bar <auxilaba'],
      ['Foo bar <auxilabA', 'Foo bar '],
      ['Foo bar <auxilabArtifacs></auxilabArtifact>', 'Foo bar <auxilabArtifacs></auxilabArtifact>'],
      ['Before <oltArtfiact>foo</auxilabArtifact> After', 'Before <oltArtfiact>foo</auxilabArtifact> After'],
      ['Before <auxilabArtifactt>foo</auxilabArtifact> After', 'Before <auxilabArtifactt>foo</auxilabArtifact> After'],
    ])('should correctly parse chunks and strip out auxilab artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <auxilabArtifact title="Some title" id="artifact_1">foo bar</auxilabArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <auxilabArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</auxilabArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</auxilabArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</auxilabArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/auxilabArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <auxilabArtifact title="Some title" id="artifact_1">foo</auxilabArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <auxilabArtifact title="Some title" id="artifact_1"><auxilabAction type="shell">npm install</auxilabAction></auxilabArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <auxilabArtifact title="Some title" id="artifact_1"><auxilabAction type="shell">npm install</auxilabAction><auxilabAction type="file" filePath="index.js">some content</auxilabAction></auxilabArtifact> After',
        {
          output: 'Before  After',
