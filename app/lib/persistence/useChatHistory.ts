            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `auxilab Restored your chat from a snapshot. You can revert this message to load the full chat history.
                  <auxilabArtifact id="restored-project-setup" title="Restored Project & Setup" type="bundled">
                  ${Object.entries(snapshot?.files || {})
                    .map(([key, value]) => {
                      if (value?.type === 'file') {
                        return `
                      <auxilabAction type="file" filePath="${key}">
${value.content}
                      </auxilabAction>
                      `;
                      } else {
