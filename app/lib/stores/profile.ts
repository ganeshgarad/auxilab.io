...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('auxilab_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('auxilab_profile', JSON.stringify(profileStore.get()));
  }
};
