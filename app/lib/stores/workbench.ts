...
export class WorkbenchStore {
  ...
  get auxilabTerminal() {
    return this.#terminalStore.auxilabTerminal;
  }
  get alert() {
  ...
  attachauxilabTerminal(terminal: ITerminal) {
    this.#terminalStore.attachauxilabTerminal(terminal);
  }
